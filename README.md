...
This was my first web python project and although it works well some of the code is fairly ugly. 
Some examples of what I will fix when I do another version:
